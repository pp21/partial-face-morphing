...
def getpotins_sw(img):
    ...
    # get points
    nosepoints = []
    nosepoints.append( points[21] )
    nosepoints.append( points[22] )
    nosepoints.append( points[42] )
    nosepoints.append( [ points[54][0], points[30][1] ] )
    nosepoints.append( [ round( ( points[35][0]+points[54][0] )/2 ), round( ( points[35][1]+points[54][1] )/2 ) ] )
    nosepoints.append( [ round( ( points[33][0]+points[51][0] )/2 ), round( ( points[33][1]+points[51][1] )/2 ) ] )
    nosepoints.append( [ round( ( points[31][0]+points[48][0] )/2 ), round( ( points[31][1]+points[48][1] )/2 ) ] )
    nosepoints.append( [ points[48][0], points[30][1] ] )
    nosepoints.append(points[39])
    bb = min( points[49][1], points[51][1], points[53][1] )
      
    return nosepoints, bb
...
def mor_nose(imgpath1, imgpath2, alpha1, alpha2):
    # Read images
